...
const getItems: (panelStyle: CSSProperties) => CollapseProps['items'] = (panelStyle) => [
    {
        ...
        children:
            <p>
                ...
                yaklaşımı ile sağlamaktadır. Biz, müşterilerimize en iyi hizmeti sunmak için sürekli olarak
                yenilikler
        ...
        <div className={classes}>
            <div className="pb-10">
                <Divider orientation="left" className="pb-2 text-xl font-bold divider-border-color">
                    <p className="text-2xl">Hoş Geldiniz!</p>
                </Divider>
                <p className="text-lg">
                    Rent a Car, seyahat deneyiminizi unutulmaz kılmak için burada! Bizimle seyahat ettiğinizde,
                    güvenilirlik, konfor ve uygun fiyatlarla dolu bir deneyim yaşayacaksınız. Misyonumuz, sizin seyahat
                    ihtiyaçlarınızı karşılamak ve seyahatlerinizi keyifli ve sorunsuz hale getirmektir. Rent a Car
                    olarak,
                    geniş araç filomuz ve müşteri odaklı yaklaşımımızla, sizin yanınızdayız.
                </p>
            </div>
            <Collapse
                defaultActiveKey={['1']}
